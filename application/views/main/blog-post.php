	...
	<div class="row">
		...
		<div class="col-xl-8 col-lg-8">
			...
			<div class="blog-post single-post">
				...
				<div class="blog-post-thumbnail">
					<div class="blog-post-thumbnail-inner">
						<span class="blog-item-tag"><?= $this->lang->line('blog_post') ?></span>
			...
			<ul id="posts-nav" class="margin-top-0 margin-bottom-40">
				<li class="next-post">
					<a href="#">
						<span><?= $this->lang->line('blog_post_next') ?></span>
						<strong><?php if(isset($nextPost[0]['title'])) echo $nextPost[0]['title'];  ?></strong>
					</a>
				</li>
				<li class="prev-post">
					<a href="#">
						<span><?= $this->lang->line('blog_post_previous') ?></span>
			...
			<div class="boxed-list margin-bottom-60">
				<?php if(!empty($this->session->userdata('user_id'))) { ?>
					<div class="boxed-list-headline">
						<h3><i class="fa fa-comments"></i> <?= $this->lang->line('blog_post_comment') ?></h3>
					</div>
					...
					<?php } else { ?>
					<div class="boxed-list-headline">
						<h3><i class="icon-material-outline-lock"></i> <?= $this->lang->line('lang_payments_view_please') ?> <a href="<?php echo base_url().'login' ?>">login</a> <?= $this->lang->line('lang_payments_view_comments') ?></h3>
					</div>	
				<?php }?>
			</div>
			<!-- Comments / End -->
		...
		<div class="col-xl-4 col-lg-4 content-left-offset">
			...
			<div class="sidebar-container">
				...
				<div class="sidebar-widget">
					<h3><?= $this->lang->line('blog_post_trending') ?></h3>
