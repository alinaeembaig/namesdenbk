            ...
            <?php $i=0; foreach ($featuredDomains as $ad) { ?>
                ...
                <div class="featured box-hover">
                    ...
                    <div class="ad-info">
                        ...
                        <h4 class="item-price"><b><?php if(isset($default_currency)) echo $default_currency; else echo '$'; ?></span>  <?php if(isset($ad['website_buynowprice'])) echo number_format(floatval($ad['website_buynowprice'])); else echo number_format(floatval($ad['website_buynowprice']));  ?></b>
                        </h4>
                    </div><!-- ad-info -->
