      ...
      <div class="main-content">
          <div class="section featureds">
            ...
            <!-- featured -->
              ...
              <div class="ad-info">
                <h2 class="item-title">
                  <strong><a href="<?php echo base_url().$ad['sell_type'].'/'.$ad['sell_web'].'/'.$ad['id'];  ?>"><?php if(isset($ad['website_BusinessName'])) echo $ad['website_BusinessName'];  ?></a></strong>
                </h2>
              ...
              <div class="ad-meta">
                <div class="meta-content">
                  <?php if(isset($ad['listing_type'])) echo strtoupper($this->lang->line($ad['listing_type']));  ?></b></span>
                </div>                  
