        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="price-body padding-top-10">
                    ...
                    <li class="clearfix">
                        <a href="<?php echo base_url().$domain['listing_option'].'/'.$domain['listing_type'].'/'.$domain['id'];  ?>"><?php echo $domain['website_BusinessName']; ?>
                            <span class="float-right"><?php if(!empty($default_currency)) echo $default_currency; else echo '$'; ?><?php echo number_format(floatval ($domain['website_buynowprice']),2); ?></span>
                        </a>
                    </li>
                    <?php } ?>
                </ul>
                ...
                <div class="price-footer margin-top-30 text-center">
                    <a href="<?php echo base_url().'search/'.$type ?>"><?php echo $this->lang->line('lang_btn_view_more'); ?> </a>
