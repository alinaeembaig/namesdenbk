		<div>
			...
			<div class="listings-container grid-layout margin-top-35">
				...
				<div class="domains-box bg-white overflow-hidden border rounded mt-4 position-relative overflow-hidden featured box-hover">
					...
					<span class="tg-themetag tg-featuretag"><?php echo $this->lang->line('lang_sponsored'); ?></span>
					<?php } ?>
					...
					<div class="domains-listing-details">
						...
						<div class="ad-meta">
							...
							<?php if(!empty($result['website_buynowprice'])) { ?>
                            	<a href="<?php echo base_url().'checkout/'.'buynow'.'/'.$result['id']; ?>" class="text-warning float-right"><i class="mdi mdi-credit-card-scan"></i><?php echo $this->lang->line('lang_btn_pay_now'); ?></a>
                            	<?php } ?>
                            <?php } else { ?>
                            <a href="#" class="add-to-cart-own text-warning float-right"><i class="mdi mdi-credit-card-scan"></i> <?php echo $this->lang->line('lang_btn_pay_now'); ?></a>  
                            <?php } ?>
						</div>
