                        ...
                        <div class="table-responsive">
                            <table class="table domain-table">
                                ...
                                <tbody>
                                    ...
                                    <td class="f-size-18 f-size-md-18 slippa-semiblod text-338"><?php if(!empty($default_currency)) echo $default_currency; else echo '$'; ?><?php if(!empty($offer['highestbid'])) echo number_format($auction['highestbid'],2); else { if(!empty($auction['website_startingprice'])) echo number_format($auction['website_startingprice'],2); } ?></td>
                                    <td class="f-size-18 f-size-md-18 slippa-semiblod text-dark"><?php echo $auction['endingdays'];  ?> <?php echo $this->lang->line('lang_info_days'); ?>  <?php echo $auction['endinghours'];  ?> <?= $this->lang->line('lang_info_hours'); ?></td>
                        ...
                        <div class="table-responsive">
                            <table class="table domain-table">
                                ...
                                <tbody>
                                    ...
                                    <td class="f-size-18 f-size-md-18 slippa-semiblod text-605"><?php echo $auction['views'];  ?></td>
                                    <td class="f-size-18 f-size-md-18 slippa-semiblod text-338"><?php if(!empty($default_currency)) echo $default_currency; else echo '$'; ?><?php if(!empty($offer['highestbid'])) echo number_format($auction['highestbid'],2); else { if(!empty($auction['website_startingprice'])) echo number_format($auction['website_startingprice'],2); } ?></td>
                                    <td class="f-size-18 f-size-md-18 slippa-semiblod text-dark"><?php echo $auction['endingdays'];  ?> <?php echo $this->lang->line('lang_info_days'); ?> <?php echo $auction['endinghours'];  ?> hours</td>
                                    <td class="text-center"><a href="<?php echo base_url().$auction['listing_option'].'/'.$auction['listing_type'].'/'.$auction['id'];  ?>" class="slippa-btn slippa-gradient2 slippa-sm4 pill"><?php echo $this->lang->line('lang_btn_place_bid'); ?></a></td>
                                    </tr>
                                </tbody>
                                <?php } } ?>
                         ...
                         <div class="table-responsive">
                            <table class="table domain-table">
                                ...
                                <tbody>
                                    ...
                                    <td class="f-size-18 f-size-md-18 slippa-semiblod text-605"><?php echo $auction['views'];  ?></td>
                                    <td class="f-size-18 f-size-md-18 slippa-semiblod text-338"><?php if(!empty($default_currency)) echo $default_currency; else echo '$'; ?><?php if(!empty($offer['highestbid'])) echo number_format($auction['highestbid'],2); else { if(!empty($auction['website_startingprice'])) echo number_format($auction['website_startingprice'],2); } ?></td>
                                    <td class="f-size-18 f-size-md-18 slippa-semiblod text-dark"><?php echo $auction['endingdays'];  ?> <?php echo $this->lang->line('lang_info_days'); ?> <?php echo $auction['endinghours'];  ?> <?php echo $this->lang->line('lang_info_hours'); ?></td>
                                    <td class="text-center"><a href="<?php echo base_url().$auction['listing_option'].'/'.$auction['listing_type'].'/'.$auction['id'];  ?>" class="slippa-btn slippa-gradient2 slippa-sm4 pill"><?php echo $this->lang->line('lang_btn_place_bid'); ?></a></td>
                                    </tr>
                                </tbody>
                                <?php } }?>
