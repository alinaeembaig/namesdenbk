...
<?php if(!empty($domainStatics)) { ?>
	<div class="content-body">
		...
		<div class="row row-sm">
			...
			<div class="col-xl-12">
				<div class="card card-hover card-analytics-one rounded">
...
<?php if(!empty($adsense) && !empty($this->session->userdata('user_id'))) { ?>
	...
	<div class="col-md-12 col-lg-12 margin-top-20 margin-bottom-40">
		...
		<div class="row margin-top-20 margin-bottom-20 p-5">
