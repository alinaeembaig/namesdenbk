...
<div class="slippa-breadcump slippa-breadcump-height breaducump-style-2">
    ...
    <div class="container">
        <div class="row slippa-breadcump-height align-items-center">
            <div class="col-lg-8 col-xl-7 mx-auto text-center text-white margin-top-80">
                ...
                <form id="home_search" name="home_search" method="post" class="margin-top-30 domain-searh-form" action="<?php echo base_url().'main/search/' ?>" data-duration="1.8s" data-dealy="0.9s" data-animation="wow fadeInUp">
                    <input id="searchterm" name="searchterm" type="text2" class="searchterm" placeholder="<?php echo $this->lang->line('lang_search_placeholder'); ?>">
                    <span class="bar"></span>
                    ...
                    <?php echo $this->lang->line('lang_btn_search'); ?> <span><i class="fas fa-angle-<?= ($l_format === 'rtl') ? 'left' : 'right'; ?>"></i></span>
                    </button>
	...
	<?php if($homepage[0]['sold-domains'] === '1'){ 
		$this->load->view('main/add-ons/sold-domains');
	} ?> 
	<!--------------------------------------------------------------------------------------------------------------->
	<!-- Domains Crousel / End-->	
</div>
...
<?php if($homepage[0]['apps'] === '1') {
	$this->load->view('main/add-ons/apps'); 
}?>
<!--------------------------------------------------------------------------------------------------------------->
...
<?php if($homepage[0]['featured-domains-slider'] === '1') {
	$this->load->view('main/add-ons/featured-domains-slider'); 
} ?>
<!--------------------------------------------------------------------------------------------------------------->
...
<?php if(in_array('website',array_column($platforms,'platform')) || in_array('account',array_column($platforms,'platform'))) { ?>
<!-- Popular website categories -->	
<!--------------------------------------------------------------------------------------------------------------->
<?php if($homepage[0]['popular-categories'] === '1') {
	$this->load->view('main/add-ons/popular-categories'); 
}?>
<!--------------------------------------------------------------------------------------------------------------->
...
<?php if($homepage[0]['social_accounts'] === '1') {
	$this->load->view('main/add-ons/social-accounts'); 
}?>
<!--------------------------------------------------------------------------------------------------------------->
<!-- Social Accounts / End-->
<?php } ?>
...
<?php if($homepage[0]['sponsored-ads'] === '1') {
	$this->load->view('main/add-ons/sponsored-ads'); 
} ?>
<!--------------------------------------------------------------------------------------------------------------->
<!-- Sponsored Ads / End-->	
...
<?php if($homepage[0]['ending-soon'] === '1') {
	$this->load->view('main/add-ons/ending-soon'); 
}?>
<!--------------------------------------------------------------------------------------------------------------->
<!-- Ending Soon / End-->	
<?php } ?>
...
<?php if($homepage[0]['domains-columns'] === '1') {
	$this->load->view('main/add-ons/domains'); 
}?>
<!--------------------------------------------------------------------------------------------------------------->
<!-- /Domains Ads / End-->
<?php } ?>
