<!----------------------------------------------------------------------------------------------------------->
<!-- header -->
<header class="slippa-site-header slippa-fixed-top white-menu" style="background-image: url(<?php if(!empty($imagesData[0]['homepage'])) echo base_url().ADMIN_IMAGES.$imagesData[0]['homepage']; ?>);">
    ...
    <div class="main-header slippa-sticky" style="background-image: url(<?php if(!empty($imagesData[0]['homepage'])) echo base_url().ADMIN_IMAGES.$imagesData[0]['homepage']; ?>);">
    <nav class="navbar">
        <div class="container">
                    ...
                    <li class="menu-item-has-children"><a href="#"><?php echo $this->lang->line('lang_header_main_buy'); ?></a>
                        <ul class="sub-menu">
                            ...
                            <?php if(in_array('account',array_column($platforms,'platform'))) { ?>
                                <li><a href="<?php echo base_url().'accounts' ?>"><?php echo $this->lang->line('lang_header_main_sub_accounts'); ?></a></li>
                            <?php } ?>
                        </ul>
                    </li>
