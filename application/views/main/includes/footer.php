                ...
                <div class="row widgets footer-widgets">
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <div class="single-widget widget-about">
                            ...
                            <img class="img-responsive footer-logo" src="<?php echo base_url();?>assets/home-assets/images/header-logo.png"
                                alt="Logo">
                            <p class="about-des-footer">Weekly breaking news, analysis and cutting edge advices on job
                                searching.</p>
                            <div class="social-icon">
                                <img class="img-responsive" src="<?php echo base_url();?>assets/home-assets/images/footer/facebook-icon.png">
                                <img class="img-responsive" src="<?php echo base_url();?>assets/home-assets/images/footer/linkedin-icon.png">
                                <img class="img-responsive" src="<?php echo base_url();?>assets/home-assets/images/footer/twitter-icon.png">
                                <img class="img-responsive" src="<?php echo base_url();?>assets/home-assets/images/footer/youtube-icon.png">
                            </div>
                        </div>
                    </div>
