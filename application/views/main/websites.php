...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <p class="lead rtl-right"><?php echo $this->lang->line('lang_websites_category_p'); ?></p>
    ...
    <span class="bookmark-icon"></span>
        ...
        <?php } else { ?> <a href="<?php echo base_url().$ad['sell_type'].'/'.$ad['sell_web'].'/'.$ad['id'];  ?>"><img src="<?php if(isset($ad['website_thumbnail'])) echo base_url().IMAGES_UPLOAD.$ad['website_thumbnail'];  ?>" alt="" class="img-sponsored"></a> 
        <?php  } } else { ?>
        ...
        <div class="user-option pull-right">
            ...
            <a href="<?php echo base_url().'checkout/'.'buynow'.'/'.$ad['id']; ?>" class="text-primary" data-toggle="tooltip" data-placement="top" title="<?= $this->lang->line('lang_txt__al_buy_now'); ?>"><i class="mdi mdi-cart-plus"></i></a>
                <?php } ?>
            <?php } else {  ?>
            <a href="#" class="add-to-cart-own text-primary" class="text-primary" data-toggle="tooltip" data-placement="top" title="<?= $this->lang->line('lang_txt__al_buy_now'); ?>"><i class="mdi mdi-cart-plus"></i></a>  
              <?php } ?>
