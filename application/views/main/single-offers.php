...
<div class="container">
	<div class="row">
		...
		<div class="imil-box margin-bottom-30">
            <div class="slippa-box-style-2" style="height: 200px; background-repeat: no-repeat; background-size: cover; background-image: url(<?php if(isset($listing_data[0]['website_cover'])) echo base_url().IMAGES_UPLOAD.$listing_data[0]['website_cover'];  ?>" class="rounded resize-icon" alt="<?php if(isset($listing_data[0]['website_cover'])) echo $listing_data[0]['website_cover'];  ?>">
            </div>
        ...
        <div class="slippa-box-style-2 margin-bottom-30 slippa-dorder-off">
            <span class="f-size-18"><span class="slippa-strong"><?= $this->lang->line('lang_payments_sponsored_tag');  ?> - </span> <a id="sponsored-dom" class="no-deco" href=""><span class="txt-rotate" data-period="2000" data-rotate=''></span></a></span>
        </div><!-- /.slippa-box-style-2 -->
        ...
        <div class="slippa-box-style-2 margin-bottom-30 content-right-offset">
        	<span class="f-size-24 d-block margin-bottom-30"><h3><b>screenshot</b></h3></span>
        ...
        <div class="imil-box">
       	...
       	<?php if(empty($this->session->userdata('user_id'))) { ?>
            ...
            <span class="f-size-24 d-block margin-bottom-30"><h3><?= $this->lang->line('lang_payments_about_business');  ?></h3></span>
           	<?php } else { ?>
		...
		<?php if(!empty($this->session->userdata('user_id'))) { ?>
			...
			<!-- Key Points -->
			<div class="single-page-section">
				<h3 class="margin-bottom-25"> <?= $this->lang->line('lang_payments_total_traffic');  ?></h3>
				<div class="row">
				<div class="col-md-12">
				<div class="content">
					<!-- Chart -->
				...
				<div class="fun-fact" data-fun-fact-color="#36bd78">
					<div class="fun-fact-text">
						<span> <?= $this->lang->line('lang_payments_total_visitors');  ?></span>
				...
				<div class="fun-fact" data-fun-fact-color="#b81b7f">
					<div class="fun-fact-text">
						<span> <?= $this->lang->line('lang_payments_total_page_views');  ?></span>
			...
			<!-- Tags -->
			<div class="single-page-section">
				<h3> <?= $this->lang->line('lang_payments_view_tags');  ?></h3>
				<div class="task-tags">
			...
			<div class="sidebar-container">
				...
				<div class="sidebar-widget">
					<div class="bidding-widget">
						<div class="bidding-headline centerButtons"><h3><?php echo strtoupper($this->lang->line('lang_single_page_offer_on_this'));  ?></h3></div>
						...
						<?php if($listing_data[0]['status'] !== '5') {
							...
							<!-- Headline -->
							<span class="bidding-detail"><strong><?= $this->lang->line('lang_payments_asking_price');  ?></strong></span>

							<!-- Price Slider -->
							<div class="bidding-value"><?php if(!empty($default_currency)) echo $default_currency; else echo '$'; ?> <?php if(!empty($listing_data[0]['website_minimumoffer'])) echo number_format($listing_data[0]['website_minimumoffer']); else echo 0; ?></div>

							<?php if($listing_data[0]['user_id'] !== $this->session->userdata('user_id')) { ?>
							<!-- Button Make Offer-->
							<a href="#small-dialog-6" class="button ripple-effect move-on-hover full-width margin-top-20 popup-with-zoom-anim"><?php echo strtoupper($this->lang->line('lang_single_page_place_offer'));  ?> <i class="icon-material-outline-arrow-right-alt"></i></a>
							<?php } ?>
							...
							<?php } else { ?>
							<div class="countdown alert alert-warning margin-bottom-35 margin-top-30"> <?= $this->lang->line('lang_single_page_own_listings'); ?> </div>
							<?php }?>
							...
							<?php } }?>
						<?php } else { ?>
						<div class="alert alert-warning text-dark margin-bottom-35 text-center"> <?= $this->lang->line('lang_payments_notice_sold'); ?> </div>
						<?php } } else { ?>
                    ...
                    <div class="slippa-box-style-2">
                        ...
                        <div class="media  margin-top-30">
                            <div class="media-body text-center">
                                ...
                                <h5 class="margin-bottom-15 f-size-24 slippa-semiblod"><a href="#"><?php if(isset($ownerData[0]['username'])) echo $ownerData[0]['username']; ?></a></h5>
				...
				<div class="sidebar-widget">
                    ...
                    <img src="<?php echo base_url()?>assets/img/safe.png" class="slippa-mr-30" alt="">
...
<?php if(!empty($this->session->userdata('user_id'))) { ?>
<script>loadDomainTrafficData('chart');</script>
<?php } ?>
