  ...
  <div id="wrapper">
    ...
    <div class="dashboard-container">
      ...
      <div class="row">
         ...
         <div class="card">
          ...
          <div class="col-xl-12">
           <div class="submit-field">
            <label for="body">Video URL </small></label>
            <input type="url" class="with-border" id="url" name="url" placeholder="http://youtube.com/videourl" required="true" />
        ...
        <div class="col-xl-12">
         <div class="submit-field">
          <label for="listing_type">Video CATEGORY (it will appear on these listings)</label>
                ...
                <tbody>
                  <?php foreach ($urls as $url) { ?>
                    <tr>
                      ...
                      <td><?= $url['url']; ?></td>
                      <td><?= strtoupper($url['listing_type']); ?></td>
                      <td>
                        <button data-id="<?= $url['id']; ?>" type="button" class="btn btn-success editVideo"><i class="fas fa-edit"></i></button>
                        <button data-id="<?= $url['id']; ?>" type="button" class="btn btn-danger deleteVideo"><i class="far fa-trash-alt"></i></button>
                      </td>
                    </tr>
                  <?php } ?>
