              ...
              <div class="card-body">
                <form id="ListingsSettingsForm" method="post" enctype="multipart/form-data"/>
                        ...
                        <div class="col-xl-12">
                          		  ...
                          		  <input type="number" class="with-border" id="listing_price" name = "listing_price" onkeypress='validateInputNumbers(event)' placeholder="Listing Price" required="true">
                          	 </div>
                        </div>
                        ...
                        <div class="col-xl-12">
                          		...
                          		<input type="number" class="with-border" id="listing_duration" name = "listing_duration" onkeypress='validateInputNumbers(event)' placeholder="Listing Duration" required="true">
                          	 </div>
                        </div>
