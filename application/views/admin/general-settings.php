					...
					<div class="dashboard-box margin-top-0 panel-group" id="accordion" role="tablist" aria-multiselectable="true">
						...
						<div class="panel panel-default">
							...
							<!-- Headline -->
								<div class="headline">
									<h3><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
									<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i> MOZ Api Keys</a></h3>
								</div>
							</div>
							...
							<div class="panel-body">
								...
								<div class="content with-padding padding-bottom-10">
									<div class="row">
										...
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>MOZ Access ID<strong>(Required for MOZ Analytics)</strong><i class="help-icon" data-tippy-placement="right" title="Required for MOZ Analytics, Leave Empty to disable"></i></h5>
												<input type="text" id="moz_access_id" name="moz_access_id" value="<?php if(isset($settings[0]['moz_access_id']) && !empty($settings[0]['moz_access_id'])) echo $settings[0]['moz_access_id']; ?>" class="with-border">
											</div>
										</div>

										<div class="col-xl-6">
											<div class="submit-field">
												<h5>MOZ Secert<strong>(Required for MOZ Analytics)</strong><i class="help-icon" data-tippy-placement="right" title="Required for MOZ Analytics, Leave Empty to disable"></i></h5>
												<input type="text" id="moz_api_key" name="moz_api_key" value="<?php if(isset($settings[0]['moz_api_key']) && !empty($settings[0]['moz_api_key'])) echo $settings[0]['moz_api_key']; ?>" class="with-border">
											</div>
										</div>
							...
							<div class="row">
								...
								<div class="col-xl-4">
									<div class="submit-field">
										<h5><span>Mark As Completed</span><i class="help-icon" data-tippy-placement="right" title="if Delivery not accepted in No of Days mark this as delivered / Please note if you have activated Escrow services this will also be your Inspecion Period"></i></h5>
								...
								<div class="col-xl-4">
									<div class="submit-field">
										<h5><span>FOOTER CREDITS</span><i class="help-icon" data-tippy-placement="right" title="This option will enable footer credits. (Powered by Onlinetoolhub) "></i></h5>
								...
								<div class="col-xl-4">
									<div class="submit-field">
										<h5>Allow User to Sell </h5>
										<select id="enable_user_selling" name="enable_user_selling" class="form-control">
										<?php if(isset($settings[0]['enable_user_selling']) && $settings[0]['enable_user_selling'] === '1') { ?>
                                            <option value="1" selected="true">On</option>
                                            <option value="0">Off</option>
                                        <?php } else { ?>
                                            <option value="1">On</option>
								...
								<?php if(isset($paymentsact[3]['status']) && $paymentsact[3]['status'] === '1') { ?>
								<div class="col-xl-4">
									<div class="submit-field">
										<h5>Run Escrow Services As </h5>
										<select id="escrow_run_as_broker" name="escrow_run_as_broker" class="form-control">
										<?php if(isset($settings[0]['escrow_run_as_broker']) && $settings[0]['escrow_run_as_broker'] === '1') { ?>
                                            <option value="1" selected="true">Broker</option>
                                        <?php } else { ?>
							...
							<!-- Headline -->
								<div class="headline">
									...
									<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i> MailChimp Setup</a> <small>(required for subscribe)</small></h3>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-xl-6">
									<div class="submit-field">
										...
										<input type="text" id="mailchimp_apikey" name="mailchimp_apikey" value="<?php if(!empty($settings[0]['mailchimp_apikey'])) echo $settings[0]['mailchimp_apikey']; ?>" class="with-border">
									</div>
								</div>

								<div class="col-xl-6">
									<div class="submit-field">
										<h5>MailChimp Listing ID <code> (<a href="https://mailchimp.com/help/find-audience-id/" target="_blank"> Click here </a> How to find this?)</code></h5>
										<input type="text" id="mailchimp_listing_id" name="mailchimp_listing_id" value="<?php if(!empty($settings[0]['mailchimp_listing_id'])) echo $settings[0]['mailchimp_listing_id']; ?>" class="with-border">
									</div>
								</div>
							...
							<!-- Headline -->
								<div class="headline">
									<h3><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="true" aria-controls="collapseFive">
