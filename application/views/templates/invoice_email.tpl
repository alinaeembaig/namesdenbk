...
<head>
  ...
  <title>{{ sitename }} {{ invoiceHeader }}</title>
  <style type="text/css">
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    <td class="left" width="129" height="20" style="padding-top:10px; text-align:left;">
                      <img class="left" width="129" height="20" src="{{ logo }}" alt="{{ sitename }}">
                    </td>
                  </tr>
                </table>
                  ...
                  <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#E5E5E5">
                    <tr>
                      <td class="center" style="padding:25px; text-align:center;">
                        <b><a href="{{ contact_us }}">{{ getInTouch }}</a></b> {{ feedback }}
                      </td>
                    </tr>
                  </table>
                </td>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%" bgcolor="#E5E5E5">
                    <tr>
                      <td class="center footer" style="font-size:12px;">
                        <a href="{{ contact_us }}">{{ contactBtn }}</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                        <span class="footer-group">
                          <a href="{{ facebook }}">{{ titleFacebook }}</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                          <a href="{{ twitter }}">{{ titleTwitter }}</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                          <a href="{{ contact_us }}">{{ titleSupport }}</a>
                        </span>
                      </td>
                    </tr>
                  </table>
