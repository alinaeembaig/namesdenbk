...
<body>
  <div class="container-scroller">
    <div class="container-fluid page-body-wrapper full-page-wrapper auth-page">
      <div class="content-wrapper d-flex align-items-center resest-password auth auth-bg-1 theme-one" style="background-image: url('<?php if(isset($imagesData[0]['mainback'])) echo base_url().ADMIN_IMAGES.$imagesData[0]['mainback']; ?>'); ">
        <div class="row w-100">
          <div class="col-lg-12 mx-auto">
            <div class="auto-form-wrapper-reset">
              ...
              <div class="welcome-text">
                ...
                <h3><?= $this->lang->line('lang_reset_password_title') ?></h3>
                <span><?= $this->lang->line('lang_reset_password_title_sub') ?></span>
              </div>
              ...
              <form id="ResetPasswordForm" class="forms-sample" method="post" enctype="multipart/form-data"/>
                ...
                <div class="form-group">
                  ...
                  <button id="button_reset" name="button_reset" class="button full-width button-sliding-icon ripple-effect margin-top-10" disabled="true"><?= $this->lang->line('lang_reset_password_btn_reset') ?></button>
                </div>
