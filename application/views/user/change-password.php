...
<!--User Page Meta Tags-->
<title><?= $this->lang->line('lang_cp_title') ?> | <?php echo $this->lang->line('site_name') ?> | <?= $this->lang->line('lang_userdashbaord_title') ?></title>
<meta charset="utf-8">
				...
				<div class="col-xl-12">
					...
					<form id="ChangePasswordForm" method="post" enctype="multipart/form-data"/>
						...
						<div class="dashboard-box">
							...
							<!-- Headline -->
							<div class="headline">
								<h3><i class="icon-material-outline-lock"></i> <?= $this->lang->line('lang_cp_sub_title') ?></h3>
							</div>
								...
								<div class="row">
									<div class="col-xl-4">
										<div class="submit-field">
											<h5><?= $this->lang->line('lang_txt_username') ?></h5>
									...
									<div class="col-xl-4">
										<div class="submit-field">
											<h5><?= $this->lang->line('lang_txt_password') ?></h5>
