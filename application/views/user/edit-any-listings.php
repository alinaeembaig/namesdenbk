			...
			<div class="dashboard-content-container" data-simplebar>
				<div class="dashboard-content-inner" >
					...
					<div class="dashboard-headline">
						<h3><b><?= $this->lang->line('lang_e_edit') ?> <?= ucfirst($this->lang->line($listingType));?> <?= $this->lang->line('lang_e_listings') ?> | </b> <?php if(isset($listing_data[0]['website_BusinessName'])) echo $listing_data[0]['website_BusinessName']; ?> | <?php if(isset($listing_data[0]['app_market'])) echo $listing_data[0]['app_market']; ?></h3>
						...
						<form id="createListingForm" name="createListingForm" method="POST" enctype="multipart/form-data">
							...
							<div class="col-xl-12">
														...
														<div class="row">
															...
															<div class="col-xl-4">
																<div class="submit-field">
																	<h5><?= ucfirst($this->lang->line($listingType));?> <?= $this->lang->line('lang_c_name') ?></h5>
															...
															<div class="col-xl-4">
																<div class="submit-field">
																	<h5><?= ucfirst($this->lang->line($listingType));?> <?= $this->lang->line('lang_c_age') ?> <span>(<?= $this->lang->line('lang_c_years') ?>)</span>  <i class="help-icon" data-tippy-placement="right" title="<?= $this->lang->line('lang_c_years_title') ?>"></i></h5>
															...
															<div class="col-xl-4">
																<div class="submit-field">
																	...
																	<input type="text" id="m_platform" name="m_platform" value="<?php if(isset($listing_data[0]['app_market'])) echo $listing_data[0]['app_market']; ?>" class="with-border" readonly="true">
																</div>
															</div>
															...
															<div class="col-xl-4">
																<div class="submit-field">
																	...
																	<select class="required" name="website_industry" id="website_industry" class="selectpicker with-border">
																		<option value=""><?= $this->lang->line('lang_c_industry_sub') ?></option>
															...
															<div class="row">
																...
																<div class="col-xl-12">
																	<div class="submit-field">
																		<h5><?= $this->lang->line('lang_c_meta_keywords') ?><span>(Important)</span>  <i class="help-icon" data-tippy-placement="right" title="Be<?= $this->lang->line('lang_c_meta_keywords_title') ?>"></i></h5>
																...
																<div class="col-xl-6">
																	<div class="submit-field">
																		<h5>D<?= $this->lang->line('lang_c_discribe_full_fil') ?></h5>
																...
																<div class="col-xl-6">
																	<div class="submit-field">
																		<h5><?= $this->lang->line('lang_c_subcribers') ?></h5>
																		<input type="text" id="monthly_downloads" name="monthly_downloads" value="<?php if(isset($listing_data[0]['monthly_downloads'])) echo $listing_data[0]['monthly_downloads']; ?>" class="with-border" placeholder="2000" onkeypress='validateInputNumbers(event)' required>
																	</div>
																</div>
															...
															<div style="<?= $listing_data[0]['listing_option'] === 'auction' ? '' : 'display:none'; ?>" class="row">

																<div class="col-xl-4">
																	<div class="submit-field">
																		<h5><?= $this->lang->line('lang_c_starting_price') ?> (<?php if(!empty($default_currency)) echo $default_currency; else echo '$'; ?>)</h5>
																		<input type="text" id="website_startingprice" name="website_startingprice" value="<?= $listing_data[0]['website_startingprice'] ?>" class="required form-control with-border" placeholder="20" onkeypress='validateInputNumbers(event)'>
																	</div>
																</div>
																...
																<div class="col-xl-4">
																	<div class="submit-field">
																		...
																		<input type="text" id="website_reserveprice" name="website_reserveprice" value="<?= $listing_data[0]['website_reserveprice'] ?>" class="required form-control with-border" placeholder="20" onkeypress='validateInputNumbers(event)'><small id="reservredPriceWebsite" class="text-danger"></small>
																	</div>
																</div>
																...
																<div class="col-xl-4">
																	<div class="submit-field">
																		...
																		<input type="text" id="website_buynowpriceauc" name="website_buynowprice" value="<?= $listing_data[0]['website_buynowprice'] ?>" class=" form-control with-border" placeholder="20" onkeypress='validateInputNumbers(event)'><small class="text-info"> <?= $this->lang->line('lang_c_empty_disable') ?></small>
																	</div>
																</div>

															</div>

															<div style="<?= $listing_data[0]['listing_option'] === 'classified' ? '' : 'display:none'; ?>" class="row">

																<div class="col-xl-4">
																	<div class="submit-field">
																		<h5><?= $this->lang->line('lang_c_minimum_offer') ?> (<?php if(!empty($default_currency)) echo $default_currency; else echo '$'; ?>)</h5>
																		<input type="text" id="website_minimumoffer" name="website_minimumoffer" value="<?= $listing_data[0]['website_minimumoffer'] ?>" class="required form-control with-border" placeholder="20" onkeypress='validateInputNumbers(event)'>
																	</div>
																</div>
																...
																<div class="col-xl-4">
																	<div class="submit-field">
																		...
																		<input type="text" id="website_buynowpriceclas" name="website_buynowprice" value="<?= $listing_data[0]['website_buynowprice'] ?>" class="form-control with-border" placeholder="20" onkeypress='validateInputNumbers(event)'><small class="text-info"> <?= $this->lang->line('lang_c_empty_disable') ?></small>
																	</div>
																</div>
								...
								<div class="col-xl-12">
									...
									<button type="submit" class="button ripple-effect big margin-top-30" style="float: right;" form="createListingForm"><i class="icon-feather-plus"></i> <?= $this->lang->line('lang_e_update_changes') ?></button>
								</div>
