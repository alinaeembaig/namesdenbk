							...
							<div class="dashboard-box margin-top-0">
								...
								<div class="headline">
									...
									<div class="input-group rounded centerButtons">
										<a href="<?= base_url() ?>user/manage_listings/name"><h3><span class="badge badge-pill badge-dark">Name</span></h3></a>&nbsp;
										<a href="<?= base_url() ?>user/manage_listings/recent"><h3><span class="badge badge-pill badge-dark">Recent</span></h3></a>&nbsp;
										<a href="<?= base_url() ?>user/manage_listings/lowest"><h3><span class="badge badge-pill badge-dark">Lowest</span></h3></a>&nbsp;
										<a href="<?= base_url() ?>user/manage_listings/highest"><h3><span class="badge badge-pill badge-dark">Highest</span></h3></a>&nbsp;
									</div>
								</div>
