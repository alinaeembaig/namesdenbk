...
<body>
  <div class="container-scroller">
    <div class="container-fluid page-body-wrapper full-page-wrapper auth-page">
      <div class="content-wrapper d-flex align-items-center auth register-page register-bg-1 theme-one" style="background-image: url('<?php if(isset($imagesData[0]['mainback'])) echo base_url().ADMIN_IMAGES.$imagesData[0]['mainback']; ?>'); ">
        <div class="row w-100">
          ...
          <div class="col-lg-12 mx-auto">
            ...
            <div class="login-register-page">
              ...
              <form id="UserRegistrationForm" class="forms-sample" method="post" enctype="multipart/form-data"/>
                ...
                <label>Captcha</label>
                <br>
                  <p id="image_captcha" class="text-center"><?php echo $captchaImg; ?></p>
            ...
            <br>
            <p class="footer-text text-center">copyright © <?php echo date('Y'); ?> <a href="<?php echo base_url(); ?>" target="_blank"> <?php echo $this->lang->line('site_name'); ?> </a><?php if($settings[0]['footer_credits'] === '1') { ?>  | Powered By <a href="https://www.onlinetoolhub.com" target="_blank"> Onlinetoolhub</a> <?php  } ?>. All rights reserved.</p>
          </div>
        </div>
      </div>
