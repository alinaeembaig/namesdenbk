...
<head>
    ...
    <!--User Page Meta Tags-->
    <title><?= $this->lang->line('lang_e_edit') ?> <?= ucfirst($this->lang->line($listingType));?> <?= $this->lang->line('lang_e_listings') ?> - <?php if(isset($listing_data[0]['website_BusinessName'])) echo $listing_data[0]['website_BusinessName']; ?> | <?php echo $this->lang->line('site_name') ?>| User Dashboard</title>
    <meta charset="utf-8">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="content with-padding padding-bottom-10">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-6">
                                                                <div class="submit-field">
                                                                    <h5><?= $this->lang->line('lang_c_meta_description')  ?> <?= ucfirst($listing_data[0]['listing_type'])?></h5>
                                                            ...
                                                            <div class="col-xl-6">
                                                                <div class="submit-field">
                                                                    <h5>Buy On GoDaddy (Leave Empty to Disable)</h5>
                                                            ...
                                                            <div class="col-xl-6">
                                                                <div class="submit-field">
                                                                    <h5>Buy On Dan (Leave Empty to Disable)</h5>
                                                                    <input type="url" id="dan_link" name="dan_link" value="<?php if(isset($listing_data[0]["dan_link"])) echo $listing_data[0]["dan_link"]; ?>" class="with-border">
                                                                </div>
                                                            </div>
                                                        </div>
