...
<!--User Page Meta Tags-->
<title><?= $this->lang->line('lang_website_listings_title') ?> | <?php echo $this->lang->line('site_name') ?> | <?= $this->lang->line('lang_userdashbaord_title') ?></title>
<meta charset="utf-8">
	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
				<h3><b><?= $this->lang->line('lang_website_listings_title') ?> </b></h3>
				...
				<nav id="breadcrumbs" class="dark">
					<ul>
						...
						<li><?= $this->lang->line('lang_website_listings_title') ?></li>
					</ul>
				</nav>
			</div>
					...
					<div class="dashboard-box margin-top-0 panel-group" id="accordion" role="tablist" aria-multiselectable="true">
								...
								<div class="content with-padding padding-bottom-10">
									<div class="row">
										<div class="col-xl-12">
											...
											<h5><?= $this->lang->line('lang_domains_enter_url') ?> <span>(<?= $this->lang->line('lang_c_imporatnt') ?>)</span>  <i class="help-icon" data-tippy-placement="right" title="Please enter a URL and verify"></i></h5>
											...
											<div id="domainVerificationDiv" style="display:none;" class="alert alert-dark">
                                        		...
                                        		<p><b><?= $this->lang->line('lang_domains_verfy_methods') ?></b></p>
						...
						<div class="panel panel-default">
							...
							<div class="row">
								...
								<div class="col-xl-4">
									<div class="submit-field">
										<h5><?= ucfirst($this->lang->line($listingType));?></b> <?= $this->lang->line('lang_c_age') ?> <span>(<?= $this->lang->line('lang_c_years') ?>)</span>  <i class="help-icon" data-tippy-placement="right" title="<?= $this->lang->line('lang_c_years_title') ?>"></i></h5>
