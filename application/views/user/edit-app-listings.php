												...
												<div class="panel-body">
													...
													<div class="content with-padding padding-bottom-10">
														<div class="row">
															...
															<div class="col-xl-4">
																<div class="submit-field">
																	<h5><?= $this->lang->line('lang_app') ?> <?= $this->lang->line('lang_c_age') ?> <span>(<?= $this->lang->line('lang_c_years') ?>)</span>  <i class="help-icon" data-tippy-placement="right" title="Should be add in years"></i></h5>
															...
															<div class="col-xl-4">
																...
																<div class="col-xl-8">
																	<div class="submit-field">
																		<h5><b> <?= $this->lang->line('lang_c_financial_overview') ?> : </b> </b> <?= $this->lang->line('lang_c_revenue_expenses') ?> <span>(<?= $this->lang->line('lang_c_net_profit') ?>)</span>  <i class="help-icon" data-tippy-placement="right" title="<?= $this->lang->line('lang_c_net_profit_title') ?>"></i></h5>
																		<div class="row">
																			<div class="col-xl-4">
