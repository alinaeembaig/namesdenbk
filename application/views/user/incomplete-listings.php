							...
							<ul class="dashboard-box-list">
								<li>
									...
									<div class="buttons-to-right">
										...
										<a href="<?php echo base_url().'user/delete__listing/'.$listing['id']; ?>" class="button green ripple-effect ico" title="Delete" data-tippy-placement="left"><i class="fa fa-trash"></i></a>
									</div>
								</li>
