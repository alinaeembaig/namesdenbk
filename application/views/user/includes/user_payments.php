...
<div id="pay_listing" class="row" style="display: none;">
    ...
    <button id="button_pay" name="button_pay" class="button big ripple-effect margin-top-40 margin-bottom-65 button_pay" >Proceed Payment</button>

    <button type="submit" class="button big ripple-effect margin-top-40 margin-bottom-65 submit" style="float: right; display: none;"> Proceed Payment </button>
