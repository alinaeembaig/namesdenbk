...
$route['item/(:any)/(:any)/(:any)']='main/single_item/$1/$2/$3';
$route['auction/(:any)/(:any)/(:any)']='main/single_auction/$1/$2/$3';
...
$route['user/manage_listings/(:any)/(:num)']='user/manage_listings/$1';
$route['user/manage_offers/(:any)/(:num)']='user/manage_offers/$1';

$route['search/(:any)']='main/search/$1';
$route['custom/styles']='main/styles';
$route['custom/script']='main/scripts';
...
$route['accounts/(:any)/(:any)']='main/accounts/$1/$2';
