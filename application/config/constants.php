...
define('PLUGINS_UPLOAD','application/libraries/');
...
define('RESULTS_ACCOUNT_HOMEPAGE',8);
define('RESULTS_ACCOUNT_PAGE',4);
define('AUCTION_HOMEPAGE_RESULTS',5);
define('RESULTS_PER_COLUMN',10);
define('RESULTS_PER_BLOG',3);
define('RESULTS_PER_SEARCH',2);
define('FOOTER_CAT_NOS',7);
define('HOME_CAT_NOS',7);
define('GOOGLE_ADSENSE',FALSE);
define('DECODE_DESCRIPTIONS',TRUE);
define('RANGE_MAX',15000000);
define('RANGE_MIN',0);
define('RANGE_STEP',10);
define('PAYMENT_PER_REF',5);
define('DEMO_MODE',false);
define('GATEWAY_ARR', array());

define('USER_LISTINGS',10);
define('USER_OFFERS',10);