			...
			<div role="tabpanel" class="tab-pane active">
				<form class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<?php
								if($web_server == $web_server_recom || (strpos($web_server, $web_server_recom) !== false) || $web_server == $web_server_recom2 || (strpos($web_server, $web_server_recom2) !== false))
								{
									success($web_server);
								}
								else 
								{
									error($web_server ."   : ".$web_server_recom." or ".$web_server_recom2." is recomended");
									$error = true;
								}
							?>
						</div>
